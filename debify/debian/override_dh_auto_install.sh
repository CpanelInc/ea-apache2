...
mkdir -p $DEB_INSTALL_ROOT/etc/apache2
mkdir $DEB_INSTALL_ROOT/var/log/apache2
chmod 711 $DEB_INSTALL_ROOT/var/log/apache2
...
chown root:nobody $DEB_INSTALL_ROOT/var/log/apache2/suexec_log
